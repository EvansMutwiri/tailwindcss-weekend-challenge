<template>
    <section class="testimonials bg-grey py-12">
            ...
            <div class="cards md:flex justify-between md:space-x-6">
                <div class="p-6 pl-12 bg-white rounded-xl shadow mx-auto my-10 w-full lg:w-1/2 space-y-6 break-all">
                    ...
                    <div class="flex space-x-6">
                        <div>
                            <img class="rounded-full h-12 w-12" src="/src/assets/pexels-pixabay-415829.jpg" alt="">
                        </div>
                        <div>
                            <h1 class="font-black">Celia Almeda</h1>
                            <p class="font-thin">CEO, Space Y</p>
                        </div>
                    </div>
                </div>
                <div class="p-6 pl-12 bg-white rounded-xl shadow mx-auto my-10 w-full lg:w-1/2 space-y-6 break-all">
                    ...
                    <div class="flex space-x-6">
                        <div>
                            <img class="rounded-full h-12 w-12" src="/src/assets/pexels-italo-melo-2379005.jpg" alt="">
                        </div>
                        <div>
                            <h1 class="font-black">Frank Kinney</h1>
                            <p class="font-thin">Finance Director, FK</p>
                        </div>
                    </div>
                </div>
            </div>
